...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = document;
              t2 = t1.querySelector(".tilt");
              t2.toString;
              t3 = type$.dynamic;
              new self.VanillaTilt(t2, A.LinkedHashMap_LinkedHashMap$_literal(["max", 25, "speed", 1000, "gyroscope", true, "gyroscopeMinAngleX", -90, "gyroscopeMaxAngleX", 90, "gyroscopeMinAngleY", -90, "gyroscopeMaxAngleY", 90, "gyroscopeSamples", 100, "scale", 1.08], t3, t3));
              $async$goto = 2;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_2000000, t3), $async$main);
            case 2:
              // returning from await.
              t2 = type$.String_Function_Match, t4 = type$.nullable_String_Function_Match, t5 = type$.nullable_String_Function_String, i = 0;
            case 3:
              // for condition
              if (!(i < 153)) {
                // goto after for
              ...
              t6 = t1.querySelector(".div2 p");
              t6.toString;
              ++i;
              J.set$innerHtml$x(t6, A.stringReplaceAllFuncUnchecked(B.JSString_methods.substring$2("Hoi!! My name is Rapougnac, (not actually my real name, duh), I'm starting a career as a backend developer, but I don't like we(e)b developement too! :3\n", 0, i), A.RegExp_RegExp("(don't)"), t4._as(t2._as(new A.main_closure())), t5._as(null)));
              $async$goto = 5;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_5000, t3), $async$main);
            case 5:
              // returning from await.
              // goto for condition
              $async$goto = 3;
  ...
  A.main_closure.prototype = {
    call$1(m) {
      return "<strike>" + A.S(m.group$1(0)) + "</strike>";
    },
    $signature: 20
  };
  A.VanillaTilt.prototype = {};
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.Iterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.Rti, A._FunctionParameters, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._ListBase_Object_ListMixin, A.ListMixin, A.SetMixin, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A._SvgNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A.DomException, A.DomImplementation, A.Location, A._NodeList_JavaScriptObject_ListMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, A.VanillaTilt]);
...
;
    ...
    B.Duration_5000 = new A.Duration(5000);
